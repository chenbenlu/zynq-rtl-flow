...
is cabled straight into the build host's second, previously unused NIC (`eth0`)
on a private point-to-point segment that exists only between those two machines.
